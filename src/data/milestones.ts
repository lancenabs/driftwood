...
export const MILESTONES: Milestone[] = [
  ...
  M({
    ...
    opening: [
      ...
      { kind: 'narration', text: 'And Bauer\'s ledger — the one he keeps in Elias\'s cave, seventy years of crossings in it — its last entry, dated the morning of your tour, in a steady seagoing hand: "Family twelve today. They argue like mine did, the winter we wrecked. If the sea takes me before I get them home — Jumble, you know the drill. Thirty-one lessons. Give them everything. They\'re why we practice." The sea has not taken him yet. The lessons kept you. The family sits down together in the cave that built the ones who saved them, the storm riding itself out beyond the falls, and lets the truth be all of it at once: the loneliest story on this island, and the reason they\'re alive inside it.' },
    ],
    instrument: {
      toolId: 'mending_bench', toolName: 'The Mending Bench',
